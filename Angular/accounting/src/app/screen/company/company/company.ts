...
import { CompanyModel, userAccessTokenDecode } from '../../../datamodels/datamodels';
...
export class CompanyComponent {
  ...
  submit(formValue: any) {
    ...
    if (decodeToken.user_id != undefined) {
      ...
      this.http.post<company>("company/",company).subscribe((value)=>{
        ...
        this.commonService.snackBar(`Company Creaded Success ${value.name}`,'',3000);
